...
@Component({
  selector: 'cs-splash-screen-layout-2',
  templateUrl: 'splash-screen-layout-2.page.html',
  styleUrls: ['splash-screen-layout-2.page.scss'],
})
export class SplashScreenLayout2Page implements OnChanges, OnDestroy {
  @Input() data: any;
